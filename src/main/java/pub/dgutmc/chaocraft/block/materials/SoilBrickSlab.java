...
public class SoilBrickSlab extends SoilBrick implements IWaterLoggable {
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        if (blockstate.getBlock() == this) {
            return blockstate.with(TYPE, SlabType.DOUBLE).with(WATERLOGGED, false).with(ISCOVER,0);
        } else {
